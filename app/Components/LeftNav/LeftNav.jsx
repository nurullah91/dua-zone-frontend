...
const LeftNav = () => {
    return (
        <div className='flex flex-row items-center px-5 py-5 rounded-badge bg-base-100 fixed lg:left-5 lg:top-5 lg:flex-col bottom-0 w-full justify-between lg:w-fit'>
